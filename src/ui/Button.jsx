...
function Button({ children, disabled, to, type, onClick }) {
  const base = `inline-block tex-sm rounded-full bg-yellow-400 font-semibold uppercase tracking-wide text-stone-800 transition-colors
   duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none
